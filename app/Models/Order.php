...
class Order extends Model
{
    ...
    protected $fillable = ['user_id', 'address_id', 'order_type', 'table_no', 'reward_points', 'delhivery_boy_id', 'barcode', 'order_no', 'total_amount', 'total_discount', 'final_amount', 'status', 'payment_status', 'payment_method'];
