            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center category-card-header">
                    <div class="category-card-header-top">
                        ...
                        <a href="{{ route('state.add') }}" class="btn btn-primary btn-sm category-card-add-btn">
                            + Add
                        </a>
                    </div>
                            ...
                            <tbody id="sortable-table">
                                @foreach ($state as $key => $item)
                                    <tr data-id="{{ $item->id }}">
                                        ...
                                        <td><p class="text-xs font-weight-bold mb-0">{{ $item->short_name }}</p></td>
