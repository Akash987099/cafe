            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center category-card-header">
                    <div class="category-card-header-top">
                        <h6 class="m-0">Attribute Value</h6>

                        <a href="{{ route('attribute_value.add') }}" class="btn btn-primary btn-sm category-card-add-btn">
                            + Add
                        </a>
                    </div>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <table class="table align-items-center mb-0 datatable">
                            ...
                            <tbody id="">
                                @foreach ($attribute_values as $key => $item)
                                    <tr data-id="{{ $item->id }}">
                                        <td>
                                            <i class="fas fa-bars text-secondary me-2 drag-handle" style="cursor:move"></i>
                                            {{ $attribute_values->firstItem() + $key }}
                                        </td>

                                        <td>
                                            <p class="text-xs font-weight-bold mb-0">{{ $item->attribute_name }}</p>
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('attribute_value.edit', $item->id) }}"
                        ...
                        <div class="mt-4">
                            {{ $attribute_values->links('shared.pagination') }}
                        </div>
                    </div>
                </div>
            </div>
