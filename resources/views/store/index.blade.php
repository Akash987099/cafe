            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center category-card-header">
                    <div class="category-card-header-top">
                        <h6 class="m-0">Store</h6>

                        <a href="{{ route('store.add') }}" class="btn btn-primary btn-sm category-card-add-btn">
                            + Add
                        </a>
                    </div>
                        ...
                        <table class="table align-items-center mb-0 datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Zipcode</th>
                            ...
                            <tbody id="sortable-table">
                                @foreach ($store as $key => $item)
                                    <tr data-id="{{ $item->id }}">
                                        ...
                                        <td><p class="text-xs font-weight-bold mb-0">{{ $item->city }}</p></td>
                                        <td><p class="text-xs font-weight-bold mb-0">{{ $item->zipcode }}</p></td>
                                        <td><p class="text-xs font-weight-bold mb-0">{{ $item->address }}</p></td>
