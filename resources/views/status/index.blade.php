            ...
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex justify-content-between align-items-center category-card-header">
                    <div class="category-card-header-top">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <a href="{{ route('status.export') }}" class="btn btn-success btn-sm">Export</a>
                            <a href="{{ route('status.add') }}" class="btn btn-primary btn-sm category-card-add-btn">
                                + Add
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <div class="mt-4">
                            {{ $status->links('shared.pagination') }}
                        </div>
                    </div>
                </div>
            </div>
